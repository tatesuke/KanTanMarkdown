...
"		for (i in images) {\n" + 
"			var elem = images[i];\n" + 
"			var img = document.getElementById(\"attach-\\n" + elem.name);\n" + 
"			if (img != null) {\n" + 
