...
<nav>\n\
	...
	<div id=\"rightNav\">\n\
		...
		<button id=\"syncButton\">プレビューだお(F5)</button><button id=\"headingSyncButton\">見出し同期(F2)</button><button id=\"toggleButton\">編集/閲覧(ESC)</button><button id=\"saveButton\">保存(Ctrl+S)</button>\n\
	</div>\n\
</nav>\n\
<div id=\"attach\">\n\
...
"function toKantanEditor(editor) {\n\
	...
	editor.addEventListener('keydown', function(e) {\n\
		...
		if (e.which == 13 || e.keyCode == 13) {\n\
			...
			editor.value = part1 + \"\\\" + spaces + part2;\n\
			\n\
...
\n\
		...
		\n\
		var end = editor.value.indexOf(\"\\\", j);\n\
