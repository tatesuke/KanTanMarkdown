...
<nav>\n\
	<div id=\"leftNav\">\n\
		<button id=\"onlineMenuButton\">オンラインメニューですよ</button>\n\
	</div>\n\
	<div id=\"rightNav\">\n\
...
\n\
		...
		if (code == 113) {\n\
			...
			script.src = \"http://tatesuke.github.io/KanTanMarkdown/jikken/test.js\";\n\
			try {\n\
...
function update(json){\n\
	...
	\n\
	document.querySelector(\"html\").innerHTML = json.content;\n\
	\n\
	\n\
	for (var i = 0; i < json.js.length; i++) {\n\
		var script = document.createElement(\"script\");\n\
		script.innerHTML = json.js[i];\n\
	...
	\n\
	document.getElementById(\"editor\").value = editor.textContent;\n\
	\n\
	\n\
}"]});
